...
// ====================================================
// GraphQL mutation operation: ToggleFavorite
// ====================================================

export interface ToggleFavorite_toggleFavoriteSession_favorites {
  __typename: "Session";
  id: string;
}

export interface ToggleFavorite_toggleFavoriteSession {
  __typename: "User";
  id: string;
  favorites: ToggleFavorite_toggleFavoriteSession_favorites[] | null;
}

export interface ToggleFavorite {
  toggleFavoriteSession: ToggleFavorite_toggleFavoriteSession | null;
}
